...
# Allow overriding APP_DIR when the app is relocated; the shim sets this env var
APP_DIR = os.environ.get("CHEST_XRAY_APP_DIR", os.path.dirname(os.path.abspath(__file__)))
